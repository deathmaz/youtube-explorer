...
const (
	// channelsView channels view name
	channelsView string = "Channels"

	// msgView message view name
	msgView string = "Message"

	// loadingView loading view name
	loadingView string = "Loading"
